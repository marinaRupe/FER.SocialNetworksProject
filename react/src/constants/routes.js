...
export const API = {
  ...
  MOVIE: {
    ...
    FETCH_USER_WATCHED_MOVIES: (page, pageSize) => `${API_URL}/movie/most-rated/?page=${page}&pageSize=${pageSize}`,
    FETCH_USER_RATED_MOVIES: (page, pageSize) => `${API_URL}/movie/most-rated/?page=${page}&pageSize=${pageSize}`,
    FETCH_USER_SAVED_MOVIES: (page, pageSize) => `${API_URL}/movie/most-rated/?page=${page}&pageSize=${pageSize}`,
  },
  REVIEWS: {
    MOVIE: {
