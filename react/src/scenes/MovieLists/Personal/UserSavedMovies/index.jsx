...
class UserSavedMovies extends Component {
  ...
  fetchMovies = page => {
    this.setState({
      ...
      const { fetchUserSavedMovies, currentUser } = this.props;
      await fetchUserSavedMovies(page, 30, currentUser); // TODO: change action
      this.setState({
        isLoading: false,
      });
    });
...
const mapDispatchToProps = {
  fetchUserSavedMovies: movieActions.fetchUserSavedMovies, // TODO: change action
};
